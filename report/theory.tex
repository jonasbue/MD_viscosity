...
% in equation \ref{eq:hard_sphere_potential}
\begin{equation}
...
% Det er et generelt problem det du beskriver om MFT.
...
% TODO:
%En anen begrensende faktor er det ekskluderte volumet i fluidet. 
% Ved lav tetthet er det en rimelig antagelse at ekskludert volum bare er partikkel-volum, men ved høy tetthet kan geometriske betraktninger føre til et noe høyere eksludert volum.
% Svar: Dette kan jeg trenge en forklaring på.
...
% TODO:
% Forklar hvorfor vanlig MD er problematisk for HS, 
% at det er mulig å gjøre slik beskrevet i den artikelen du fikk, 
% men at det ikke er praktisk dersom andre interaksjonspotensial er tilstede i tillegg.
...
%
at it's minimal value, % Is it necessary to point out this?
%
