\begin{tikzpicture}
    ...
    \pgfplotsinvokeforeach{1.000e+00, 1.500e+00, 2.000e+00}{
        ...
        \addplot+ [
                ...
                y = thorne_BMCSL,
                col sep = comma,
                y error plus = error_thorne_BMCSL,
                y error minus = error_thorne_BMCSL,
            ...
            \addplot+ [
                ...
                x = pf,
                y expr = \thisrow{thorne_SPT}/\thisrow{thorne_BMCSL},
                col sep = comma,
            ]{data/theory_varying_mass_large.csv};
            \addplot+ [
                color=black,
                ...
                x = pf,
                y expr = \thisrow{thorne_BMCSL}/\thisrow{thorne_BMCSL},
                col sep = comma,
            ]{data/theory_varying_mass_large.csv};
            \addplot+ [
                color=black,
                ...
                x = pf,
                y expr = \thisrow{enskog_1}/\thisrow{thorne_BMCSL},
                col sep = comma,
            ]{data/theory_varying_mass_large.csv};
            \addplot+ [
                color=black,
                ...
                x = pf,
                y expr = \thisrow{thorne_PY}/\thisrow{thorne_BMCSL},
                col sep = comma,
            ]{data/theory_varying_mass_large.csv};
    }
    \end{groupplot}
